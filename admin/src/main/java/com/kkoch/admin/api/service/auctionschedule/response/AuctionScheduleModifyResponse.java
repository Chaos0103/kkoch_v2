...
public class AuctionScheduleModifyResponse {
    ...
    @Builder
    private AuctionScheduleModifyResponse(int auctionScheduleId, PlantCode code, AuctionRoomStatus roomStatus, LocalDateTime auctionDateTime, LocalDateTime modifiedDateTime) {
