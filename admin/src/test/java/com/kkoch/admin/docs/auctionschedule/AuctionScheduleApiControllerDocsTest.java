...
public class AuctionScheduleApiControllerDocsTest extends RestDocsSupport {
    ...
    void searchAuctionSchedules() throws Exception {
        AuctionScheduleResponse auctionSchedule = AuctionScheduleResponse.builder()
            .auctionScheduleId(1)
        ...
        PageResponse<AuctionScheduleResponse> response = PageResponse.create(List.of(auctionSchedule), pageRequest, 1);

        given(auctionScheduleQueryService.searchAuctionSchedules(any()))
            .willReturn(response);
            ...
            .andDo(document("search-auction-schedules",
                ...
                responseFields(
                    ...
                    fieldWithPath("data.content").type(JsonFieldType.ARRAY)
                        .description("경매 일정 목록"),
                    fieldWithPath("data.content[].auctionScheduleId").type(JsonFieldType.NUMBER)
                        .description("경매 일정 ID"),
                    fieldWithPath("data.content[].plantCategory").type(JsonFieldType.STRING)
                        .description("화훼부류"),
                    fieldWithPath("data.content[].roomStatus").type(JsonFieldType.STRING)
                        .description("경매 방 상태"),
