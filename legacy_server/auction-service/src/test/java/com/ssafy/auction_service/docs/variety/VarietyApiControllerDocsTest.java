...
class VarietyApiControllerDocsTest extends RestDocsSupport {
    ...
    @DisplayName("품종 삭제 API")
    @Test
    void removeVariety() throws Exception {
        VarietyRemoveResponse response = VarietyRemoveResponse.builder()
            .code("10031204")
            .plantCategory("절화")
            .itemName("장미")
            .varietyName("하트앤소울")
        ...
        given(varietyService.removeVariety(anyString()))
            .willReturn(response);
