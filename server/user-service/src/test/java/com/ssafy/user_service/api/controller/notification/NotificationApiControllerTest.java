...
class NotificationApiControllerTest extends ControllerTestSupport {
    ...
    @NullAndEmptySource
    @ParameterizedTest
    void openNotificationsWithoutIds(List<Long> ids) throws Exception {
    ...
    @DisplayName("알림 다중 삭제시 알림 ID 목록은 필수값이다.")
    @NullAndEmptySource
    @ParameterizedTest
    void removeNotificationsWithoutIds(List<Long> ids) throws Exception {
        NotificationOpenRequest request = NotificationOpenRequest.builder()
            .ids(ids)
            .build();
